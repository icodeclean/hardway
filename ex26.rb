...
- Your own methods need to be called  "like mymethod(object)" ?
- Certain inbuilt methods need to be called as object.inbuilt().
- Some builtin methods like shift make changes to the object: x=word.shift will change word as well as give x a value 
- In the above, is x assigned and the remaining returned? or x returned and the remaining...
