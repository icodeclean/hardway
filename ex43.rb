class Game
  ...
  def central_corridor()
    ...
    if action == "shoot!"
      ...
      puts "as the Gothon laser cranks a laser past your head"
      ...
      puts "Lbhe zbgure vf fb sng, jura fur fvgf nebhaq gur ubhfr, fur fvgf nebhaq gur ubh"
      puts "The Gothon stops, tries not to laugh, then burst out laughing and can't move."
  ...
  def the_bridge()
    puts "You burst onto the Bridge with ethe neutron destruct bomb"
  ...
  def escape_pod()
    ...
    if guess.to_i != good_pod
      ...
      puts "back and see your ship implode and explod like a"
